...
!> @brief Initialisation functionality for the adjoint_test miniapp
...
module init_adjoint_test_mod
  ...
  use adjoint_test_constants_mod,     only : create_adjoint_test_constants

  implicit none

  contains

  subroutine init_adjoint_test( mesh, chi, panel_id, dt, field_1)
    ...
    call log_event( 'adjoint_test: Initialising miniapp ...', LOG_LEVEL_INFO )
    ...
    ! Create adjoint_test runtime constants. This creates various things
    ! needed by the fem algorithms such as mass matrix operators, mass
    ! matrix diagonal fields and the geopotential field
    call create_adjoint_test_constants(mesh, chi, panel_id)

    call log_event( 'adjoint_test: Miniapp initialised', LOG_LEVEL_INFO )

  end subroutine init_adjoint_test

end module init_adjoint_test_mod
